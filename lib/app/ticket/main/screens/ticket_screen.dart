                ...
                child: RefreshIndicator(
                    ...
                    child: CustomScrollView(
                      slivers: <Widget>[
                        SliverFillRemaining(
                          child: Obx(
                            () => _ticketController.ticketsList.isNotEmpty
                                ? GridView.builder(
                                    gridDelegate:
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        _ticketController.ticketsList.length,
                                    itemBuilder: (context, index) {
                                      Ticket item =
                                          _ticketController.ticketsList[index];
                                      return Center(
                                        child: TicketItem(
