                        ...
                        child: Stack(
                          ...
                          children: [
                            Container(
                              ...
                              padding: EdgeInsets.only(
                                left:
                                    Get.locale?.languageCode == 'en' ? 25.0 : 0,
                                right:
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        (Get.locale?.languageCode == 'en'
                                                ? decisionsResponse?.jobNameEn
                                                : decisionsResponse?.jobName) ??
                                            "",
                                        style: TextStyle(
                                          color: AppColors.white,
                                          fontSize: 14.sp,
                ...
                child: Column(
                  children: [
                    DecisionDetailsInput(
                      ...
                      enabled:
                          decisionsResponse?.subject != null ? false : true,
                    ...
                    DecisionDetailsInput(
                      ...
                      paddingTop: 20.h,
                      paddingBottom: 20.h,
                      controller: decisionsResponse?.description == null
                          ? _decisionsDetailsController
                              .descriptionTextEditingController
                          : null,
                      initialValue: decisionsResponse?.description,
                      enabled:
                          decisionsResponse?.description != null ? false : true,
                      nbrLines: 13,
                      hint: Get.locale?.languageCode == 'en'
                          ? 'Description'
                          : 'الوصف',
