                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GetBuilder<CreateMailController>(
                            builder: (_) =>
                                CustomDropdown<Department>.searchRequest(
                              items: _createMailController.departmentList,
                              closedHeaderPadding:
                                  EdgeInsets.only(bottom: 10.h),
                              visibility: (value) =>
                                  _createMailController.changeTextColor(value),
                              listItemBuilder: (context, department, isSelected,
                                  onItemSelect) {
                                return Text(
                                  Get.locale?.languageCode == 'en'
                              ...
                              futureRequest: (String dep) =>
                                  _createMailController.searchDepartment(dep),
                            ),
                          ),
                        ],
                      ),
