...
class RecommendationUpdate extends StatelessWidget {
  ...
  final List<RecommendationItem> recItemsList;
      ...
      child: Column(
        children: [
          Container(
            ...
            child: GetBuilder<EvaluationsUpdateStepsController>(
              builder: (_) => GridView.builder(
                ...
                itemCount: recItemsList
                    .where((test) => test.isAnswerCheckBox == true)
