...
class FinalExitPageBindings extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<FinalExitController>(() => FinalExitController());
  }
}
...
class EvaluationsUpdateStepsPageBindings extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<EvaluationsUpdateStepsController>(
        () => EvaluationsUpdateStepsController());
  }
}
